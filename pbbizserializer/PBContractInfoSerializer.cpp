/***********************************************************************
 * Module:  PBContractInfoSerializer.cpp
 * Author:  milk
 * Modified: 2015年7月12日 19:10:41
 * Purpose: Implementation of the class PBContractInfoSerializer
 ***********************************************************************/
...
#include "../dataobject/TemplateDO.h"
 ...
 ////////////////////////////////////////////////////////////////////////
 // Name:       PBContractInfoSerializer::Serialize(const dataobj_ptr& abstractDO)
 // Purpose:    Implementation of PBContractInfoSerializer::Serialize()
 // Parameters:
 // - abstractDO
 // Return:     data_buffer
 ////////////////////////////////////////////////////////////////////////

data_buffer PBContractInfoSerializer::Serialize(const dataobj_ptr& abstractDO)
{
...
////////////////////////////////////////////////////////////////////////
// Name:       PBContractInfoSerializer::Deserialize(const data_buffer& rawdata)
// Purpose:    Implementation of PBContractInfoSerializer::Deserialize()
// Parameters:
// - rawdata
// Return:     dataobj_ptr
////////////////////////////////////////////////////////////////////////

dataobj_ptr PBContractInfoSerializer::Deserialize(const data_buffer& rawdata)
{
