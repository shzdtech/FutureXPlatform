...
public:
   ...
   virtual void* LoadModule(const std::string& moduleUUID, const std::string& modulePath)=0;
   virtual void* FindModule(const std::string& moduleUUID)=0;
   virtual bool CreateInstance(const void* handle, const std::string& classUUID, void** instance)=0;
   virtual void* FindFunction(const void* handle, const std::string& funcName)=0;
   virtual bool UnloadModule(const std::string& moduleUUID)=0;
