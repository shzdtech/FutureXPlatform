/***********************************************************************
 * Module:  CTPUnsubMarketDataSA.h
 * Author:  milk
 * Modified: 2015年3月6日 20:11:00
 * Purpose: Declaration of the class CTPUnsubMarketData
 ***********************************************************************/

#if !defined(__CTP_CTPUnsubMarketDataSA_h)
#define __CTP_CTPUnsubMarketDataSA_h

#include "../message/MessageHandler.h"
#include "ctpexport.h"

class CTP_CLASS_EXPORT CTPUnsubMarketDataSA : public MessageHandler
{
public:
