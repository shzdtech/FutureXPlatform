...
int CTPMDLoginHandler::LoginFunction(IRawAPI* rawAPI, CThostFtdcReqUserLoginField* loginInfo)
{
	std::string value;
	...
	return ((CTPRawAPI*)rawAPI)->MdAPI->ReqUserLogin(loginInfo, ++_requestIdGen);
}