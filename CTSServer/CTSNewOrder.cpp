...
////////////////////////////////////////////////////////////////////////
// Name:       CTSNewOrder::HandleResponse(ParamVector& rawParams, IRawAPI* rawAPI, ISession* session)
...
dataobj_ptr CTSNewOrder::HandleResponse(ParamVector& rawParams, IRawAPI* rawAPI, ISession* session)
{
