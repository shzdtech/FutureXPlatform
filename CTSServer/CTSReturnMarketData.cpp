...
////////////////////////////////////////////////////////////////////////
// Name:       CTSReturnMarketData::HandleResponse(ParamVector& rawParams, IRawAPI* rawAPI, ISession* session)
...
dataobj_ptr CTSReturnMarketData::HandleResponse(ParamVector& rawParams, IRawAPI* rawAPI, ISession* session)
{
