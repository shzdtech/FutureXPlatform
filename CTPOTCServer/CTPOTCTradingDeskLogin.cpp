...
////////////////////////////////////////////////////////////////////////
// Name:       CTPOTCTradingDeskLogin::HandleRequest(dataobj_ptr reqDO, IRawAPI* rawAPI, ISession* session)
...
dataobj_ptr CTPOTCTradingDeskLogin::HandleRequest(dataobj_ptr reqDO, IRawAPI* rawAPI, ISession* session)
{
