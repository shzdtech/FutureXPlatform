...
void protobuf_AssignDesc_usermanager_2eproto() {
  ...
  static const int PBUserInfo_offsets_[15] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(PBUserInfo, username_),
...
void protobuf_AddDesc_usermanager_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\021usermanager.proto\022\024Micro.Future.Messag"
    "e\032\022commondefine.proto\"\264\002\n\nPBUserInfo\0220\n\006"
    ...
    "\010lastName\030\006 \001(\t\022\016\n\006gender\030\007 \001(\005\022\017\n\007compa"
    "ny\030\010 \001(\t\022\r\n\005email\030\t \001(\t\022\022\n\ncontactNum\030\n "
    "\001(\t\022\023\n\013identityNum\030\013 \001(\t\022\017\n\007address\030\014 \001("
    "\t\022\017\n\007zipcode\030\r \001(\t\022\014\n\004role\030\016 \001(\005\022\022\n\nperm"
    "ission\030\017 \001(\005\"v\n\016PBUserInfoList\0220\n\006header"
    "\030\001 \001(\0132 .Micro.Future.Message.DataHeader"
    "\0222\n\010userInfo\030\002 \003(\0132 .Micro.Future.Messag"
    "e.PBUserInfob\006proto3", 500);
...
const int PBUserInfo::kUserNameFieldNumber;
...
PBUserInfo::PBUserInfo()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:Micro.Future.Message.PBUserInfo)
}
...
PBUserInfo::PBUserInfo(const PBUserInfo& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:Micro.Future.Message.PBUserInfo)
}
...
PBUserInfo::~PBUserInfo() {
  // @@protoc_insertion_point(destructor:Micro.Future.Message.PBUserInfo)
  SharedDtor();
}
...
// @@protoc_insertion_point(message_clear_start:Micro.Future.Message.PBUserInfo)
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:Micro.Future.Message.PBUserInfo)
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
        ...
        if (tag == 18) {
         parse_userId:
          ...
          DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            ...
            "Micro.Future.Message.PBUserInfo.userId"));
        } else {
          goto handle_unusual;
        }
        ...
        if (tag == 26) {
         parse_userName:
          ...
          DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            ...
            ::google::protobuf::internal::WireFormatLite::PARSE,
            "Micro.Future.Message.PBUserInfo.userName"));
        } else {
          goto handle_unusual;
        }
        ...
        if (tag == 34) {
         parse_password:
          ...
          DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            ...
            ::google::protobuf::internal::WireFormatLite::PARSE,
            "Micro.Future.Message.PBUserInfo.password"));
        } else {
          goto handle_unusual;
        }
        ...
        if (tag == 42) {
         parse_firstName:
          ...
          DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            ...
            ::google::protobuf::internal::WireFormatLite::PARSE,
            "Micro.Future.Message.PBUserInfo.firstName"));
        } else {
          goto handle_unusual;
        }
        ...
        if (tag == 50) {
         parse_lastName:
          ...
          DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            ...
            ::google::protobuf::internal::WireFormatLite::PARSE,
            "Micro.Future.Message.PBUserInfo.lastName"));
        } else {
          goto handle_unusual;
        }
      ...
      case 7: {
        ...
        if (input->ExpectTag(66)) goto parse_company;
        break;
      }
        ...
        if (tag == 66) {
         parse_company:
          ...
          DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            ...
            ::google::protobuf::internal::WireFormatLite::PARSE,
            "Micro.Future.Message.PBUserInfo.company"));
        } else {
          goto handle_unusual;
        }
        ...
        if (tag == 74) {
         parse_email:
          ...
          DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            ...
            ::google::protobuf::internal::WireFormatLite::PARSE,
            "Micro.Future.Message.PBUserInfo.email"));
        } else {
          goto handle_unusual;
        }
        if (input->ExpectTag(82)) goto parse_contactNum;
        break;
      }
        ...
        if (tag == 82) {
         parse_contactNum:
          ...
          DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            ...
            ::google::protobuf::internal::WireFormatLite::PARSE,
            "Micro.Future.Message.PBUserInfo.contactNum"));
        } else {
          goto handle_unusual;
        }
        if (input->ExpectTag(90)) goto parse_identityNum;
        break;
      }
        ...
        if (tag == 90) {
         parse_identityNum:
          ...
          DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            ...
            ::google::protobuf::internal::WireFormatLite::PARSE,
            "Micro.Future.Message.PBUserInfo.identityNum"));
        } else {
          goto handle_unusual;
        }
        ...
        if (tag == 98) {
         parse_address:
          ...
          DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            ...
            ::google::protobuf::internal::WireFormatLite::PARSE,
            "Micro.Future.Message.PBUserInfo.address"));
        } else {
          goto handle_unusual;
        }
        if (input->ExpectTag(106)) goto parse_zipcode;
        break;
      }
        ...
        if (tag == 106) {
         parse_zipcode:
          ...
          DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            ...
            ::google::protobuf::internal::WireFormatLite::PARSE,
            "Micro.Future.Message.PBUserInfo.zipcode"));
        } else {
          goto handle_unusual;
        }
...
success:
  // @@protoc_insertion_point(parse_success:Micro.Future.Message.PBUserInfo)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:Micro.Future.Message.PBUserInfo)
  return false;
#undef DO_
}
...
void PBUserInfo::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:Micro.Future.Message.PBUserInfo)
  // optional .Micro.Future.Message.DataHeader header = 1;
  if (this->has_header()) {
  ...
  // @@protoc_insertion_point(serialize_end:Micro.Future.Message.PBUserInfo)
}

::google::protobuf::uint8* PBUserInfo::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:Micro.Future.Message.PBUserInfo)
  // optional .Micro.Future.Message.DataHeader header = 1;
  if (this->has_header()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:Micro.Future.Message.PBUserInfo)
  return target;
}

int PBUserInfo::ByteSize() const {
// @@protoc_insertion_point(message_byte_size_start:Micro.Future.Message.PBUserInfo)
  int total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:Micro.Future.Message.PBUserInfo)
  if (GOOGLE_PREDICT_FALSE(&from == this)) MergeFromFail(__LINE__);
  const PBUserInfo* source = 
      ::google::protobuf::internal::DynamicCastToGenerated<const PBUserInfo>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:Micro.Future.Message.PBUserInfo)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:Micro.Future.Message.PBUserInfo)
    MergeFrom(*source);
  }
}

void PBUserInfo::MergeFrom(const PBUserInfo& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:Micro.Future.Message.PBUserInfo)
  if (GOOGLE_PREDICT_FALSE(&from == this)) MergeFromFail(__LINE__);
  if (from.has_header()) {
...
// @@protoc_insertion_point(generalized_copy_from_start:Micro.Future.Message.PBUserInfo)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:Micro.Future.Message.PBUserInfo)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
const ::Micro::Future::Message::DataHeader& PBUserInfo::header() const {
  // @@protoc_insertion_point(field_get:Micro.Future.Message.PBUserInfo.header)
  return header_ != NULL ? *header_ : *default_instance_->header_;
}
::Micro::Future::Message::DataHeader* PBUserInfo::mutable_header() {
...
::Micro::Future::Message::DataHeader* PBUserInfo::release_header() {
...
void PBUserInfo::set_allocated_header(::Micro::Future::Message::DataHeader* header) {
  delete header_;
  header_ = header;
  if (header) {
...
PBUserInfoList::PBUserInfoList()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:Micro.Future.Message.PBUserInfoList)
}
...
PBUserInfoList::PBUserInfoList(const PBUserInfoList& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:Micro.Future.Message.PBUserInfoList)
}
...
PBUserInfoList::~PBUserInfoList() {
  // @@protoc_insertion_point(destructor:Micro.Future.Message.PBUserInfoList)
  SharedDtor();
}
...
// @@protoc_insertion_point(message_clear_start:Micro.Future.Message.PBUserInfoList)
  if (GetArenaNoVirtual() == NULL && header_ != NULL) delete header_;
  header_ = NULL;
  userinfo_.Clear();
}
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:Micro.Future.Message.PBUserInfoList)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 2: {
        ...
        if (input->ExpectTag(18)) goto parse_loop_userInfo;
...
success:
  // @@protoc_insertion_point(parse_success:Micro.Future.Message.PBUserInfoList)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:Micro.Future.Message.PBUserInfoList)
  return false;
#undef DO_
}
...
void PBUserInfoList::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:Micro.Future.Message.PBUserInfoList)
  // optional .Micro.Future.Message.DataHeader header = 1;
  if (this->has_header()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      1, *this->header_, output);
  ...
  // @@protoc_insertion_point(serialize_end:Micro.Future.Message.PBUserInfoList)
}

::google::protobuf::uint8* PBUserInfoList::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:Micro.Future.Message.PBUserInfoList)
  // optional .Micro.Future.Message.DataHeader header = 1;
  if (this->has_header()) {
    target = ::google::protobuf::internal::WireFormatLite::
      WriteMessageNoVirtualToArray(
  ...
  // @@protoc_insertion_point(serialize_to_array_end:Micro.Future.Message.PBUserInfoList)
  return target;
}

int PBUserInfoList::ByteSize() const {
// @@protoc_insertion_point(message_byte_size_start:Micro.Future.Message.PBUserInfoList)
  int total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:Micro.Future.Message.PBUserInfoList)
  if (GOOGLE_PREDICT_FALSE(&from == this)) MergeFromFail(__LINE__);
  const PBUserInfoList* source = 
      ::google::protobuf::internal::DynamicCastToGenerated<const PBUserInfoList>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:Micro.Future.Message.PBUserInfoList)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:Micro.Future.Message.PBUserInfoList)
    MergeFrom(*source);
  }
}

void PBUserInfoList::MergeFrom(const PBUserInfoList& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:Micro.Future.Message.PBUserInfoList)
  if (GOOGLE_PREDICT_FALSE(&from == this)) MergeFromFail(__LINE__);
...
// @@protoc_insertion_point(generalized_copy_from_start:Micro.Future.Message.PBUserInfoList)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:Micro.Future.Message.PBUserInfoList)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
const ::Micro::Future::Message::DataHeader& PBUserInfoList::header() const {
  // @@protoc_insertion_point(field_get:Micro.Future.Message.PBUserInfoList.header)
  return header_ != NULL ? *header_ : *default_instance_->header_;
}
::Micro::Future::Message::DataHeader* PBUserInfoList::mutable_header() {
...
::Micro::Future::Message::DataHeader* PBUserInfoList::release_header() {
...
void PBUserInfoList::set_allocated_header(::Micro::Future::Message::DataHeader* header) {
  delete header_;
  header_ = header;
  if (header) {
